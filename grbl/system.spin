...
PUB ISR(CONTROL_INT_vect) | pin       'XXX needs own cog
...
PUB system_check_safety_door_ajar
...
' settings, initiating the homing cycle, and toggling case states. This differs from
' the realtime command module by being susceptible to when Grbl is ready to execute the
' next line during a cycle, so for casees like block delete, the switch only effects
    ...
    "$", "G", "C", "X":
        ...
        case( line[1] ) 
            ...
            "G": ' Prints gcode parser state
                ...
                report_gcode_modes
            "C": ' Set check g-code mode [IDLE/CHECK]
